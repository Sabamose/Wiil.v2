  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className={`flex-1 flex flex-col bg-gray-50 transition-all duration-200 ease-in-out ${
        isMobile ? 'ml-0 pt-16' : (isHome ? 'ml-60' : (isCollapsed ? 'ml-20' : 'ml-60'))
      }`}>
        {/* Header */}
        <header className={`${isMobile ? 'fixed top-0 left-0 right-0 z-50' : 'relative'} bg-white border-b border-gray-200 p-4 flex items-center justify-between shadow-sm`}>
          <div>
