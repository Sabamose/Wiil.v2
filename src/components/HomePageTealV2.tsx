...
import SimpleAdaptiveNavigation from "@/components/SimpleAdaptiveNavigation";
    ...
    <>
      ...
      <section className="relative max-w-6xl mx-auto px-6 pt-6 pb-14">
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-normal tracking-tight text-muted-foreground">Welcome back, Saba! 👋</h1>
